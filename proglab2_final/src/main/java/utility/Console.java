...
public class Console {
    ...
    public Console(CommandManager commandManager, Scanner userScanner, ProductAsk productAsk) {
    ...
    public void interactiveMode() {
        ...
        try {
            ...
            Console.printerror("епредвиденная ошибка!");
        }
    }
    ...
    private int launchCommand(String[] userCommand) {
        switch (userCommand[0]) {
            ...
            case "history":
                ...
                break;
            case "summ_of_price":
                if (!commandManager.summOfPrice(userCommand[1])) return 1;
                break;
            case "min_by_id":
                if (!commandManager.minBySemesterEnum(userCommand[1])) return 1;
                break;
            case "count_greater_than_unit_of_measure":
                if (!commandManager.counterGreaterThan(userCommand[1])) return 1;
                break;
            case "exit":
