...
//                System.out.println(jsonReader);
                ...
                Console.printerror("Загрузочный файл поврежден!");
                ...
                Console.printerror("В загрузочном файле неправильные значения полей!");
            } catch (Exception e) {
                Console.printerror("В загрузочном файле неправильные значения!");
            }
